...
// Generated by metaharness — the `rvdna` CLI entry point.
//
// This is plain ESM JavaScript on purpose: it runs as-is via `npx rvdna`
...
// "bin" + "files" fields in package.json), so `npx rvdna` works the moment
...
const HARNESS_NAME = 'rvdna';

/** `rvdna init` — boot the kernel + host adapter and report status. */
async function init() {
...
/** `rvdna doctor` — verify the install end-to-end (kernel + host resolve). */
